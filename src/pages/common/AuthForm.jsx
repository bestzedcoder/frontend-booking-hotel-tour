      ...
      {isGoogle && (
        <>
          ...
          <button
            ...
            disabled={disabled}
            className="w-full py-2 px-4 border border-gray-300 rounded font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-2"
          >
